...
Automatiskt skydd finns nu: `npm run lint:icon-shadowing` (scripts/lint-lucide-builtin-shadowing.ts) skannar alla lucide-react-imports mot en reserverad global-lista och failar på oaliasade kollisioner; registrerad som valideringssteg "icon-shadowing".
