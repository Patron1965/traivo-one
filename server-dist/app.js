...
const exportDir = path_1.default.join(projectRoot, 'dist-export');
const templatesDir = path_1.default.join(projectRoot, 'server', 'templates');
function getMetadata() {
    const metaPath = path_1.default.join(exportDir, 'metadata.json');
...
function getExpoSdkVersion() {
    try {
        const expoPkg = JSON.parse(fs_1.default.readFileSync(path_1.default.join(projectRoot, 'node_modules', 'expo', 'package.json'), 'utf-8'));
...
app.use('/_expo', express_1.default.static(path_1.default.join(exportDir, '_expo'), {
...
app.use('/assets', express_1.default.static(path_1.default.join(exportDir, 'assets')));
