# Kinab prod-verifikation 20260707-1632

- Tenant: `kinab`
- Dev-diff: AV
- Förväntat min antal aktiva kunder: 0

**Resultat:** FAIL (PASS=11, WARN=0, FAIL=5)
...
| PASS | count: customers (aktiva) | 0 (≥ 0) |
...
| INFO | count: articles | 6 |
| INFO | count: article_components | 0 |
| INFO | count: price_lists (tenant) | 1 |
...
- [ ] Ta `pg_dump` av prod-DB:n och lagra som rollback-snapshot
      ...
      "$PROD_DATABASE_URL" > kinab-prod-postverify-20260707-1632.sql`).
