...
export function TenantBrandingProvider({ children }: { children: React.ReactNode }) {
  ...
  const contextValue: BrandingContextValue = {
    ...
    companyName: branding?.companyName || "Plannix",
    logoUrl: branding?.logoUrl || null,
    logoIconUrl: (branding?.logoIconUrl && !branding.logoIconUrl.includes("traivo_logo") && !branding.logoIconUrl.includes("traivo_koncept")) ? branding.logoIconUrl : null,
