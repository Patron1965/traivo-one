...
const allNavItems: NavItemConfig[] = [
  ...
  { title: "Omräkningslogg (faktura)", url: "/invoice-recalculation-log", icon: Receipt, category: "System", keywords: ["faktura", "omräkning", "frozen", "spårbarhet", "bokföring"] },
  ...
  { title: "Demo: Investor pitch", url: "/investor-pitch", icon: Presentation, category: "Plattform", keywords: ["pitch", "investor", "investerare", "slide", "presentation", "demo"], adminOnly: true },
