  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const summary = [
        ...
        "",
        "Genom att först bevisa värde med designpartners bygger vi grunden",
      ...
      doc.setFontSize(12);
      doc.setFont("helvetica", "bold");
      doc.text("Branschspecifika anpassningar", 14, yPos);
      yPos += 6;
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Badge variant="secondary">Design Partners</Badge>
