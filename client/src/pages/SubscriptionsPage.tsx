...
export default function SubscriptionsPage() {
  ...
  const createMutation = useMutation({
    ...
    onError: (error: Error) => toast({ title: "Kunde inte skapa abonnemang", description: error.message || "Ett oväntat fel uppstod. Kontrollera uppgifterna och försök igen.", variant: "destructive" }),
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (error: Error) => toast({ title: "Kunde inte uppdatera abonnemang", description: error.message || "Ett oväntat fel uppstod. Försök igen.", variant: "destructive" }),
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error: Error) => toast({ title: "Kunde inte ta bort abonnemang", description: error.message || "Ett oväntat fel uppstod. Försök igen.", variant: "destructive" }),
  });
  ...
  const generateOrdersMutation = useMutation({
    ...
    onError: (error: Error) => toast({ title: "Kunde inte generera ordrar", description: error.message || "Ett oväntat fel uppstod. Försök igen.", variant: "destructive" }),
  });
