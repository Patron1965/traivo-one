...
export default function LundstamsROIPage() {
  ...
  const generatePDF = async () => {
    ...
    pdf.setFontSize(10);
    pdf.text("Plannix - AI-driven faltserviceplanering", pageWidth - margin - 80, 38);
    ...
    pdf.text("Med Plannix", margin + 100, y);
    ...
    pdf.setFontSize(8);
    pdf.text("Sida 1/2 | ROI-analys Lundstams | (C) 2026 Plannix", margin, pageHeight - 10);
    ...
    pdf.setFontSize(14);
    pdf.setFont("helvetica", "bold");
    pdf.text("Plannix-funktioner for Lundstams", margin, y);
    ...
    pdf.setTextColor(148, 163, 184);
    pdf.setFontSize(8);
    pdf.text("Sida 2/2 | ROI-analys Lundstams | (C) 2026 Plannix | Konfidentiellt", margin, pageHeight - 10);
    ...
    <div className="p-6 space-y-8 max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Beräknad avkastning vid implementation av Plannix</p>
        </div>
        <Button 
          onClick={generatePDF} 
