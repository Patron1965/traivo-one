...
export default function PitchPage() {
  ...
  const generatePDF = async () => {
    ...
    pdf.setFontSize(8);
    pdf.text("Sida 1/2 | © 2026 Traivo", margin, pageHeight - 10);
    ...
    pdf.setFontSize(20);
    pdf.setFont("helvetica", "bold");
    pdf.text("Traivo - En komplett lösning", margin, 22);
    ...
    pdf.setFont("helvetica", "normal");
    pdf.setTextColor(71, 85, 105);
    pdf.text("Traivo löser alla dessa problem i en enda plattform - byggd specifikt för nordiska fältserviceföretag.", margin, y);
    ...
    pdf.setTextColor(148, 163, 184);
    pdf.setFontSize(8);
    pdf.text("Sida 2/2 | © 2026 Traivo | www.traivo.se | info@traivo.se", margin, pageHeight - 10);
  ...
  return (
    <div className="p-6 space-y-8 max-w-5xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Traivo Pitch</h1>
      ...
      <Card className="border-green-200 dark:border-green-900 bg-green-50/50 dark:bg-green-950/20">
        ...
        <CardContent className="space-y-6">
          <p className="text-muted-foreground">
            Traivo löser alla dessa problem i en enda plattform - byggd specifikt för nordiska fältserviceföretag.
          </p>
