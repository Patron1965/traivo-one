const MOCK_RESOURCE: Record<string, any> = {
  ...
  role: 'technician',
  phone: '070-111 22 33',
  email: 'erik.lindqvist@plannix.se',
...
const MOCK_TEAM: any = {
  ...
  members: [
    ...
    },
    {
      ...
      phone: '070-222 33 44',
      email: 'anna.johansson@plannix.se',
      isOnline: true,
      latitude: 59.1900,
      longitude: 17.6350,
    },
...
const MOCK_RESOURCES = [
  MOCK_RESOURCE,
  { id: 202, name: 'Anna Johansson', phone: '070-222 33 44', email: 'anna.johansson@plannix.se', type: 'driver' },
  { id: 303, name: 'Karl Eriksson', phone: '070-333 44 55', email: 'karl.eriksson@plannix.se', type: 'driver' },
  { id: 404, name: 'Maria Nilsson', phone: '070-444 55 66', email: 'maria.nilsson@plannix.se', type: 'driver' },
];
