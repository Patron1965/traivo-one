...
addSection("Modus:");
addBody("Medarbetare, fordon, tillganglighet, resurskompetenser, geografiska omraden");
y += 3;
addSection("Unicorn - Nytt:");
addBullet("Resurser med kompetenser och hemposition");
addBullet("Resurskompetenser - koppling mellan resurs och artiklar de kan utfora");
...
addBody("Resurser                    | Ja       | Ja + Kompetenser");
