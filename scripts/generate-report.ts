...
// Title
addTitle("Rapport: Nya funktioner i Nordic Routing");
...
y += 3;
addSection("Nordic Routing - Nytt:");
...
y += 3;
addSection("Nordic Routing - Nytt utokat flode (6 steg):");
...
y += 3;
addSection("Nordic Routing - Helt nytt:");
...
y += 3;
addSection("Nordic Routing - Utokat:");
...
y += 3;
addSection("Nordic Routing - Forberett for:");
...
addBullet("Integration med extern Nordic Routing optimerings-API (kommande)");
y += 10;

// Summary table
addSubtitle("Sammanfattning");
y += 3;
addBody("Funktion                    | Modus    | Nordic Routing");
addBody("--------------------------------------------------------");
...
fs.writeFileSync("Rapport_Nordic_Routing_vs_Modus.pdf", Buffer.from(pdfOutput));
console.log("PDF saved: Rapport_Nordic_Routing_vs_Modus.pdf");
