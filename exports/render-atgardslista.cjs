...
(async () => {
  ...
  const fileUrl = 'file://' + path.resolve('exports/atgardslista.html');
  ...
  await page.screenshot({ path: 'exports/traivo-atgardslista.png', fullPage: true });
  await page.pdf({
    path: 'exports/traivo-atgardslista.pdf',
    width: dims.w + 'px',
    height: (dims.h + 2) + 'px',
