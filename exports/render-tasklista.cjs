...
(async () => {
  ...
  const fileUrl = 'file://' + path.resolve('exports/tasklista.html');
  ...
  await page.screenshot({ path: 'exports/traivo-tasklista.png', fullPage: true });
  await page.pdf({
    path: 'exports/traivo-tasklista.pdf',
    width: dims.w + 'px',
    height: (dims.h + 2) + 'px',
